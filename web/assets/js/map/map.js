...
$(document).ready(function () {
    ...
    numberOfQuestions = 0;
    $("#mainContainer").append("<div class='sectionDiv' id='section" + currentNumberOfSections + "'><i class='material-icons' style='position: absolute;top:10px;left:10px;color: rgba(0,0,0,0.6)' id='section" + currentNumberOfSections + "' onclick='deleteSection(this.id)'>delete</i><span class='mySpan' style='position:absolute;top: 15px;right: 15px;font-size: 16px;font-weight: bold;color: rgba(0,0,0,0.6)'>" + currentNumberOfSections + "/" + totalNumberOfSections + "</span><input type='text' class='headerInputs' placeholder='Section Name' id='sectionName" + currentNumberOfSections + "'/><br><br><i class='material-icons' style='position: absolute;top:10px;left:40px;color: rgba(0,0,0,0.6)' id='sectionAddQuestion" + currentNumberOfSections + "' onclick='clickedAddQuestion(this.id)'>add_circle</i></div>");
});
...
$(document).on("click", "#addAnotherSection", function () {
    currentNumberOfSections++;
    totalNumberOfSections++;
    $("#mainContainer").append("<center><div class='sectionDiv' id='section" + currentNumberOfSections + "'><i class='material-icons' style='position: absolute;top:10px;left:10px;color: rgba(0,0,0,0.6)' id='section" + currentNumberOfSections + "' onclick='deleteSection(this.id)'>delete</i><span class='mySpan' style='position:absolute;top: 15px;right: 15px;font-size: 16px;font-weight: bold;color: rgba(0,0,0,0.6)'>" + currentNumberOfSections + "/" + totalNumberOfSections + "</span><input type='text' class='headerInputs' placeholder='Section Name' id='sectionName" + currentNumberOfSections + "'/><br><br><i class='material-icons' style='position: absolute;top:10px;left:40px;color: rgba(0,0,0,0.6)' id='sectionAddQuestion" + currentNumberOfSections + "' onclick='clickedAddQuestion(this.id)'>add_circle</i></div></center>");
...
function clickedAddQuestion(buttonID) {
    ...
    $("#section" + sectionNumber).append("<div style='margin-top: 15px;' class='question" + sectionNumber + "'><input class='form-control' type='text' style='width: 70%; display: inline; ' placeholder=' Question Content..' /> <select name='select' style='width: 20%; ;padding: 5px;border: none'><option value='text' selected>Text</option><option value='image'>Picture</option><option value='scale'>Scale</option><option value='numeric'>Numeric</option></select><i class='material-icons' onclick='$(this).parent().get(0).remove();' style='width: 5%; position: relative; top:10px; font-size: 30px;color: red;'>clear</i></div>");
}
